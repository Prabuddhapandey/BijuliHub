    ...
    <h5>[ <small><?php echo $count2;?> </small>] types of item.</h5>  
      ...
      <table class="table table-condensed table-bordered">
          ...
          <?php 
            ...
            $query2=mysqli_query($dbconn,"SELECT * FROM products WHERE prod_id='11'") or die (mysqli_error($dbconn));
          ...
          ?>
              ...
              <tr>
                  ...
                  <?php
// Define or initialize $prod_id with a valid value
$prod_id = 11; // Replace 123 with the actual product ID you want to retrieve

// Perform the SQL query
$query2 = mysqli_query($dbconn, "SELECT * FROM products WHERE prod_id='$prod_id'") or die(mysqli_error($dbconn));
...
if ($row2) {
    // Access $row2['prod_name'] and $row2['prod_desc'] here
    echo '<td><b>' . $row2['prod_name'] . '</b><br><br>' . $row2['prod_desc'] . '</td>';
} else {
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Manila City">Hetauda</option>
                      <option value="Caloocan City">kathmandu</option>
                      <option value="Las Pinas City">Lalitpur</option>
                      <option value="Makati City">bhaktapur</option>
                      <option value="Malabon City">Dolakha</option>
                      <option value="Mandaluyong City">Rolpa</option>
                      <option value="Marikina City">Darchula</option>
                      <option value="Muntinlupa City">Baglung</option>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by CAB team
                </div>
            </div>
        </footer>
    </div>
