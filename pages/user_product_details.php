...
?>
                        ...
                        while($res = mysqli_fetch_array($result)){
                                    ...
                                    if (isset($_POST['submit'])){
                                        ...
                                        mysqli_query($dbconn,"INSERT INTO order_details (prod_id,prod_qty,total_qty,order_id,total,user_id)
                                                VALUES ('$prod_id','$prod_qty','','','$total','$user_id')") or die(mysql_error($dbconn));
                                            ?>
