...
<form method="post">
  ...
  <table class="table table-bordered table-condensed">
              ...
              <tbody>
                ...
                $query=mysqli_query($dbconn,"SELECT * FROM order_details WHERE order_details_id='$order_id'") or die (mysqli_error($dbconn));
                $row=mysqli_fetch_array($query);
                $count=mysqli_num_rows($query);
                $prod_id=$row['prod_id'];
                $query2=mysqli_query($dbconn,"SELECT * FROM products WHERE prod_id='$prod_id'") or die (());
