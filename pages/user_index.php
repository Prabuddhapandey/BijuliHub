            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/ironman.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        ...
                        <br><br>
                        <h3>Electric Items and Electronic components.</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    ...
                    <section class="promo">
      <img src="promo-image1.jpg" alt="70% off on electric appliances">
      <div class="promo-text">
        <h2>90% off on electric appliances</h2>
        <a href="#" class="shop-now-btn">Shop Now</a>
      </div>
      </section>
      <img src="promo-image.jpg" alt="70% off on electric appliances">
      <div class="promo-text">
        <a href="#" class="shop-now-btn">Shop Now</a>
      </div>
      </section>
                    ...
                    ?>   
                        <div class="row-sm-3">
                            ...
                            <div class="caption">
                              ...
                              <h6><a class="btn btn-success btn-round" title="Click for more details!" href="user_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">NRS:<?php echo $res['prod_price']; ?></medium></h6>
                            </div>
