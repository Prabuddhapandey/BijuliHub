                                      ...
                                      <br><br>
                                        <table id="" class="table table-bordered table-striped">
                                          <thead>
                                            ...
                                            <?php
                                                $query=mysqli_query($dbconn,"SELECT * FROM logs NATURAL JOIN users ORDER BY date DESC")or die(mysqli_error($dbconn));
                                      ...
                                      <br><br>
                                        <table id="" class="table table-bordered table-striped">
                                          <thead>
                                            ...
                                            <?php
                                                $query=mysqli_query($dbconn,"SELECT * FROM logs NATURAL JOIN admin ORDER BY date DESC")or die(mysqli_error($dbconn));
                                                while($row=mysqli_fetch_array($query)){ 
                                            ?>
                                          <tr>
                                            <td><?php echo $row['firstname']." ".$row['lastname']." ".$row['action']." last ".$row['date'];?></td>
        ...
        <footer class="footer" data-background-color="black">
           <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Team(College Of Applied Business)
                </div>
            </div>
        </footer>
    </div>
